...
public class View extends JFrame {
    ...
    private int getIntFromTextField(JTextField textField, String fieldName) {
        ...
        try {
            ...
            showErrorDialog(fieldName + " must be a valid integer.");
            throw e;
        }
    }
    ...
    public int getTimeLimit() {
        return getIntFromTextField(timeTextField, "Time Limit");
    }

    public int[] getServiceTimeInterval() {
        return new int[]{
                getIntFromTextField(minstTF, "Minimum Service Time"),
                getIntFromTextField(maxstTF, "Maximum Service Time")
        };
    }

    public int[] getArrivalTimeInterval() {
        return new int[]{
                getIntFromTextField(minArrivalTimeTextField, "Minimum Arrival Time"),
                getIntFromTextField(maxArrivalTimeTextField, "Maximum Arrival Time")
        };
    }

    public int getNoQueues() {
        return getIntFromTextField(nrQueuesTF, "Number of Queues");
    }

    public int getNoClients() {
        return getIntFromTextField(nrClientsTF, "Number of Clients");
    }
